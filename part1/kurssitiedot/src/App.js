//Tehtävät 1.1 & 1.2 & 1.3 & 1.4 & 1.5 (1.3 commit jäi välistä)
...
const Total = (props) => {
  ...
  return (
    <div>
      <p>Courses total {props.course.parts[0].exercises + props.course.parts[1].exercises + props.course.parts[2].exercises}</p>
    </div>
  )
}
